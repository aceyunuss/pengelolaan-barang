				...
				<tr>
					<td>
						<table class="tabel-keterangan-laporan">
							<tr>
								<td colspan="2" class="nama-laporan">LAPORAN FACILITY REQUEST</td>
							</tr>
							<tr>
					...
					<td class="kolom-nama-apotek">
						<span class="nama-apotek">PT KERETA COMMUTER INDONESIA</span><br>
						Stasiun Juanda, Jl. Ir. H. Juanda I - Jakarta Pusat 10120 Indonesia<br>
						Telepon: 021-3453535
					</td>
				</tr>
			</table>
	...
	<?php 
	 ...
	 ?>
	 	<div class="data-kosong">
	 		Tidak terdapat data request dengan kriteria tersebut
	 	</div>
	<?php } else {?>
		 ...
		 ?>
			...
			<div style="width: 100%; max-width: 100%; margin-bottom: 20px;">
				<table class="tabel-daftar-obat" border="1" style="border-collapse: collapse;">
					<tr>
						<th class="kol-nmobat">Nama Barang</th>
				...
				<?php 
					$query_obat = "SELECT * FROM tbl_pembeliandetail INNER JOIN tbl_databarang ON tbl_pembeliandetail.kd_barang = tbl_databarang.kd_barang WHERE tbl_pembeliandetail.no_faktur = '$no_faktur'";
				 ...
				 ?>
					<tr>
						...
						<td class="kol-subt">Rp<?php echo number_format($data_barang['subtotal'], 0,",", "."); ?></td>
					</tr>
				<?php } ?>
					<tr>
						<td colspan="4"></td>
