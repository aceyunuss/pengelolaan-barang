<?php 
 ...
 -->		<?php 
		 ...
		 ?>
			...
			<?php 
				$query_obat = "SELECT * FROM tbl_penjualandetail INNER JOIN tbl_databarang ON tbl_penjualandetail.kd_barang = tbl_databarang.kd_barang WHERE tbl_penjualandetail.no_penjualan = '$no_penjualan'";
