<?php 
	...
	$query = "INSERT INTO tbl_databarang (kd_barang, nm_barang, ktg_barang, bnt_barang, sat_barang, hrg_barang, hrgbeli_barang, stk_obat, minstk_obat) VALUES('$kode', '$nama', '$ktg', '$bentuk', '$satuan', '$harga_jual', '$harga', '$stok', '$min_stok')";
