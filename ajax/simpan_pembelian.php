<?php 
	...
	for($i = 0; $i < count($_POST["hidden_kdobat"]); $i++) {
		...
		$query_stok = "SELECT stk_obat, hrgbeli_barang FROM tbl_databarang WHERE kd_barang = '$kd_barang'";
		...
		$query_estok = "UPDATE tbl_databarang SET stk_obat='$stok_baru', hrgbeli_barang = '$harga', hrg_barang = '$harga_jual' WHERE kd_barang='$kd_barang'";
