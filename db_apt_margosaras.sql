...
CREATE TABLE IF NOT EXISTS `tbl_databarang` (
  ...
  `hrgbeli_barang` int(11) NOT NULL,
  `stk_barang` int(11) NOT NULL,
  `minstk_barang` int(11) NOT NULL,
...
INSERT INTO `tbl_databarang` (`kd_barang`, `nm_barang`, `exp_barang`, `ktg_barang`, `bnt_barang`, `sat_barang`, `hrg_barang`, `hrgbeli_barang`, `stk_barang`, `minstk_barang`) VALUES
