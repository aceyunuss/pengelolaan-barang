<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item"><a href="?page=datapembelian"><i class="fas fa-shopping-bag"></i> Data Laporan FR</a></li>
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-file"></i> Form Laporan Facility Request</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Form Laporan Facility Request</h4></div>
		<div class="col-6 text-right">
			<a href="?page=datapembelian">
				<button class="btn btn-sm btn-info">Data FR </button>
			</a>
		</div>
	</div>
	<div class="form-container">
		<div class="row">
			<div class="col-md-6 offset-md-3 offset-form">
				<h6><i class="fas fa-list-alt"></i> Lengkapi form ini untuk mencetak laporan fasility request</h6>
