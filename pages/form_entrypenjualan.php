<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Keluar Masuk Aset Fasilitas</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Keluar Masuk Fasilitas</h4></div>
		<div class="col-6 text-right">
			<a href="?page=datapenjualan">
				<button class="btn btn-sm btn-info">Data Fasilitas</button>
			</a>
		</div>
	</div>
...
$(document).ready(function() {
    ...
    $("#tambah_obat").click(function() {
        ...
        if(kode=="") {
            ...
            output += '<td>'+kode+' <input type="hidden" name="hidden_kdobat[]" id="td_kd_barang'+count+'" class="td_kd_barang" value="'+kode+'"></td>';
