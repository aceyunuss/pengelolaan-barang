<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-chart-bar"></i> Perencanaan Fasilitas</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Perencanaan Fasilitas</h4></div>
    	...
    	// } 
    		...
    		$.ajax({
                ...
                success:function(data) {
                    ...
                    if(objKode!="") {
	                    Swal.fire(
			              'Belum ada transaksi request',
			              'maaf, untuk '+objKode+' belum terdapat transaksi request yang dilakukan selama periode yang dipilih sebelumnya',
			              'warning'
			            )
	                } else {
	                	Swal.fire({
				          title: 'peringatan',
				          text: 'untuk melakukan peramalan bulan depan dibutuhkan data request bulan ini, apakah anda yakin data request bulan ini telah lengkap',
				          type: 'warning',
