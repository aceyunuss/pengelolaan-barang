<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Entry FR</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Form Entry FR</h4></div>
		<div class="col-6 text-right">
			<a href="?page=datapembelian">
				<button class="btn btn-sm btn-info">Data Pengajuan</button>
			</a>
		</div>
	</div>
