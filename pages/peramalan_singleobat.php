<?php 
	...
	for($i=10; $i>=0; $i--) {
		if($prd_ramalan=="per_hari") {
			...
			$data[$i][2] = $dpenjualan['jumlah_terbeli'];

			$data_ses[$i][0] = $dpenjualan['tgl_awal'];
			$data_ses[$i][1] = $tanggal_akhir;
			$data_ses[$i][2] = $dpenjualan['jumlah_terbeli'];
