<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="?page=entry_datapembelian"><i class="fas fa-align-left"></i> Form FR</a></li>
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-shopping-bag"></i> Data Facility Request</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Data Pengajuan FR</h4></div>
		<div class="col-6 text-right">
      <a href="?page=form_laporanpembelian" class="btn btn-sm btn-pink">
        Buat Laporan FR
      </a>
			<a href="?page=entry_datapembelian">
				<button class="btn btn-sm btn-info">Transaksi Pengajuan Fasilitas</button>
			</a>
		</div>
	</div>
    <style>
