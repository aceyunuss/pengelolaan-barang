<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="?page=entry_datapenjualan"><i class="fas fa-align-left"></i> Keluar Masuk Aset Fasilitas</a></li>
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-file-invoice-dollar"></i> Data Aset</li>
  </ol>
</nav>
